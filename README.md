...
前往 [Releases](https://github.com/eggfly/LILYGO-Spark-NG/releases) 下载：
...
```bash
git clone https://github.com/eggfly/LILYGO-Spark-NG.git
cd LILYGO-Spark-NG
...
# 手动创建 .app bundle
mkdir -p "dist/LILYGO Spark NG.app/Contents/MacOS"
mkdir -p "dist/LILYGO Spark NG.app/Contents/Resources"
cp target/release/lilygo-spark-ng "dist/LILYGO Spark NG.app/Contents/MacOS/"
cp resources/AppIcon.icns "dist/LILYGO Spark NG.app/Contents/Resources/"
